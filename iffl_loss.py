# -*- coding: utf-8 -*-
"""
Created on Tue Oct 12 10:20:04 2021

@author: IT Doctor
"""
""" Modified Focal Loss Implementation """
...
class if_focal_loss(LossFunctionWrapper):
...
def sigmoid_focal_crossentropy_1(
    ...
    return tf.reduce_sum(alpha_factor * modulating_factor * weighted_b_ce, axis=-1)