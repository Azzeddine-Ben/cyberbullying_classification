...
def mcnn_model(bert_model):
  ...
  ###### Features inputs
  stylometric_inputs = keras.layers.Input(shape=(4, ))
  ...
  liwc_inputs = keras.layers.Input(shape=(77,))
  dense_liwc = keras.layers.Dense(50)(liwc_inputs)
  dense_liwc = keras.layers.Activation('relu')(dense_liwc)

  sentiment_inputs = keras.layers.Input(shape=(6,))
  dense_sentiments = keras.layers.Dense(50)(sentiment_inputs)
  dense_sentiments = keras.layers.Activation('relu')(dense_sentiments)
  ...
  concat = keras.layers.Concatenate()([pool1, pool2, pool3, use_layer, dense_sty, dense_lex, 
                                       dense_rdbt, dense_liwc, dense_sentiments])
