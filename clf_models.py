...
def mcnn_model_with_features(bert_model):
  ...
  concat = keras.layers.Concatenate()([pool1, pool2, pool3, use_layer, input_lexical, input_readability, input_sentiments, input_stylometric])
...
def mcnn_blstm_model_with_features(bert_model):
  ...
  bilstm = keras.layers.Bidirectional(keras.layers.LSTM(40, activation='relu'))(pool_concat)
  concat = keras.layers.Concatenate()([bilstm, use_layer, input_lexical, input_readability, input_sentiments, input_stylometric])
